...
import 'package:seg_iv_drip/helper/isolate_inference.dart';
...
class ImageSegmentationHelper {
  ...
  _loadModel() async {
    ...
    //   options.addDelegate(NnApiDelegate()); // Android Hardware acceleration
    // } else if (Platform.isIOS) {
    //   options.addDelegate(GpuDelegate()); // iOS GPU acceleration
    // }
  ...
  Future<void> initHelper() async {
    ...
    debugPrint("Input shape in helper: $_inputShape");
    debugPrint("Output shape in helper: $_outputShape");
